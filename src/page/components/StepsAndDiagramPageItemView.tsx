...
type StepsAndDiagramPageItemViewProps = {
  readonly pageItem: StepsAndDiagramPageItem;
  readonly currentStepIndex: number;
  // readonly makePageUrl: (bookName: string, pageName: string, stepName: string) => string;
};

export class StepsAndDiagramPageItemView extends React.PureComponent<StepsAndDiagramPageItemViewProps> {

  public render(): JSX.Element {
    const pageItem = this.props.pageItem;
