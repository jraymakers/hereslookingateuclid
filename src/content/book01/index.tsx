...
const definitionGroupPages: StepsAndDiagramPageMap = {
  ...
  [def20to21.name]: { ...bookPage, stepsAndDiagram: def20to21, prev: def19Nav,       next: prop01Nav},
};

const propositionPages: StepsAndDiagramPageMap = {
  [prop01.name]: { ...bookPage, stepsAndDiagram: prop01, prev: def20to21Nav, next: prop02Nav },
